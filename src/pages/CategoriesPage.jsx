...
export function CategoriesPage() {
  const { t } = useTranslation(['catalog', 'home'])
  ...
  return (
    <div className="mx-auto w-full max-w-[var(--page-max-width)] px-4 py-12 lg:px-6 lg:py-16">
      ...
      <ResourceState
        ...
        errorMessage={t('catalog:categories.error')}
      >
              ...
              >
                ...
                <div className="p-5">
                  <p className="text-sm leading-relaxed text-muted-foreground">
                    {category.description ?? t('home:categories.fallbackDescription')}
                  </p>
                </div>
              </Link>
            </li>
