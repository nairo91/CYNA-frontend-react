export const siteText = {
  ...
  pages: {
    ...
    products: {
      ...
      pricePlaceholderMin: '0',
      pricePlaceholderMax: '999',
      availableOnlyLabel: 'Disponibles uniquement',
      ...
      resultsCountSingular: '{total} produit',
      resultsCountPlural: '{total} produits',
      fallbackPrice: 'Sur devis',
    ...
    productDetail: {
      ...
      unavailableHint: 'Ce service n\'est pas disponible actuellement. Contactez-nous pour connaitre les delais.',
      descriptionTitle: 'Description',
      similarTitle: 'Services similaires',
      similarSubtitle: 'D\'autres solutions de la meme categorie.',
      similarEmpty: 'Aucun autre service a proposer dans cette categorie.',
    },
    cart: {
      eyebrow: 'Votre panier',
      title: 'Recapitulatif de votre selection',
      copy: 'Modifiez les quantites, durees ou supprimez des lignes avant de commander.',
      ...
      months: 'mois',
      quantity: 'Quantite',
      quantityIncrease: 'Augmenter la quantite',
      quantityDecrease: 'Diminuer la quantite',
      remove: 'Supprimer',
      subtotal: 'Sous-total',
      ...
      alertUnavailable: 'Service indisponible — il sera retire automatiquement au paiement.',
      itemsCountSingular: '{count} article',
    ...
    checkout: {
      ...
      stepLabel: 'Etape',
      stepperAddress: 'Adresse',
      stepperSummary: 'Recapitulatif',
      stepperPayment: 'Paiement',
      stepperConfirmation: 'Confirmation',
      continueToSummary: 'Continuer',
      editAddress: 'Modifier',
      addressSummaryTitle: 'Adresse de facturation',
      itemsSummaryTitle: 'Articles',
      backToPrevious: 'Etape precedente',
    ...
    account: {
      ...
      ordersYearFilter: 'Annee',
      ordersYearAll: 'Toutes',
      ordersSearch: 'Rechercher (reference)',
      ordersPrint: 'Imprimer / PDF',
      ordersStatusCompleted: 'Confirmee',
      ordersStatusPending: 'En attente',
      ordersStatusCancelled: 'Annulee',
      genericError: "Une erreur est survenue. Veuillez reessayer.",
    },
    verifyEmail: {
      ...
      copyError: 'Le lien de verification est invalide ou a expire.',
      toLogin: 'Aller a la connexion',
      resendCta: 'Renvoyer l\'email de verification',
      resendEmailLabel: 'Adresse e-mail',
      resendSending: 'Envoi...',
      resendSuccess: 'Email renvoye. Verifiez votre boite de reception.',
